...
export const getListOpenaiConversationsUrl = (
  params?: ListOpenaiConversationsParams,
) => {
  ...
  return stringifiedParams.length > 0
    ? `/api/openai/conversations?${stringifiedParams}`
...
export const listOpenaiConversations = async (
  ...
  return customFetch<OpenaiConversation[]>(
    getListOpenaiConversationsUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getListOpenaiConversationsQueryKey = (
  ...
  return [`/api/openai/conversations`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListOpenaiConversationsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listOpenaiConversations>>
  > = ({ signal }) =>
    listOpenaiConversations(params, { signal, ...requestOptions });
